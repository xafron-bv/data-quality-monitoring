        ...
        for item in materials:
            ...
            if 0 < material_frequency < self.total_records * 0.05:
                ...
                return AnomalyError(
                    ...
                    confidence=min(0.95, 1.0 - (material_frequency / self.total_records)),
                    details={
                        "material": material,
            ...
            if material in self.percentage_distribution and len(self.percentage_distribution[material]) > 5:
                ...
                if abs(percentage - mean_pct) > 2 * std_pct:
                    ...
                    return AnomalyError(
                        ...
                        confidence=min(0.9, abs(z_score) / 5),  # Cap at 0.9
                        details={
                            "material": material,
        ...
        if len(material_set) > 1:
            ...
            if 0 < combination_frequency < self.total_records * 0.05:
                return AnomalyError(
                    ...
                    confidence=min(0.9, 1.0 - (combination_frequency / self.total_records)),
                    details={
