    ...
    def _detect_anomaly(self, value: Any, context: Dict[str, Any] = None) -> Optional[AnomalyError]:
        ...
        if self.total_seasons > 10 and 0 < season_frequency < self.total_seasons * 0.05:
            return AnomalyError(
                ...
                probability=min(0.85, 1.0 - (season_frequency / self.total_seasons)),
                details={
                    "season": value,
        ...
        if self.total_seasons > 10 and 0 < format_frequency < self.total_seasons * 0.05:
            return AnomalyError(
                ...
                probability=min(0.8, 1.0 - (format_frequency / self.total_seasons)),
                details={
                    "season": value,
        ...
        if season_name:
            ...
            if self.total_seasons > 10 and 0 < name_frequency < self.total_seasons * 0.05:
                ...
                return AnomalyError(
                    ...
                    probability=min(0.75, 1.0 - (name_frequency / self.total_seasons)),
                    details={
                        "season": value,
